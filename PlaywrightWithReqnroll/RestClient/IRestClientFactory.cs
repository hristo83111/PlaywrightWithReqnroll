...
public interface IRestClientFactory
{
    ...
    Task<FluentRestClient> CreateClientWithJWTTokenAsync(string baseUrl, string bearerToken);
    ...
    Task<FluentRestClient> CreateClientWithBasicAuthenticationAsync(string baseUrl, HttpCredentials credentials);
    ...
    Task<FluentRestClient> CreateUnauthenticatedClientAsync(string baseUrl);
}